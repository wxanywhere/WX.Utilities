...
namespace WX.Data.View.Controls
{
  public class PolarPanel : Panel
  {
    ...
    private static bool ValidateElementWidth(object value)
    {
      double ElementWidth = (double)value;
      return !double.IsNaN(ElementWidth) && !double.IsInfinity(ElementWidth);
    }

    public static readonly DependencyProperty ElementWidthProperty =
        DependencyProperty.RegisterAttached("ElementWidth", typeof(double), typeof(PolarPanel), new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.AffectsParentMeasure), ValidateElementWidth);
